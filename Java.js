...
let emp12 = new Designer("Anton1 ", "Kuhut", 1000, 11, 0.8);
let emp11 = new Designer("Anton2 ", "Kuhut", 1000, 11, 0.8);
let emp5 = new Developer("Anton3 ", "Kuhut", 1000, 11);
let emp6 = new Developer("Anton4 ", "Kuhut", 1000, 11);
let emp7 = new Developer("Danylo ", "Kylinyak", 1000, 11);
let emp8 = new Designer("Anton5 ", "Kuhut", 1000, 11, 0.8);
let emp9 = new Designer("Volodymyr ", "Zelenskyi", 1000, 11, 0.8);
let emp10 = new Developer("Anton6 ", "Kuhut", 1000, 11);
let emp2 = new Developer("Ostap ", "Bender", 1500, 5);
let emp4 = new Developer("Vovan ", "Pivko", 1300, 6);
let emp13 = new Developer("Vovan ", "Pivko", 1300, 6);
let emp3 = new Manager("Stepan ", "Bandera", 2000, 8, [emp13,emp11, emp2, emp4, emp10, emp9, emp8, emp7, emp6, emp5, emp12]);
